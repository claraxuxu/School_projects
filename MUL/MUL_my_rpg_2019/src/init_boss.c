...
void init_bossthree(global_t *g)
{
    ...
    g->boss->leave = sfRectangleShape_create();
    sfRectangleShape_setSize(g->boss->leave, (sfVector2f) { 300, 127});
    sfRectangleShape_setPosition(g->boss->leave, (sfVector2f) {810, 440});
    sfRectangleShape_setTexture(g->boss->leave,
