...
//prntf.c
Test(prntf, testprntf, .init = redirect_all)
{
    prntf("this is a test");
    cr_assert_stdout_eq_str("this is a test");
}

Test(prntf, testprntfint, .init = redirect_all)
{
    prntf("this is a test:%i", 17);
    cr_assert_stdout_eq_str("this is a test:17");
}

Test(prntf, testprntfstr, .init = redirect_all)
{
    prntf("this is a test:%s", "lol");
    cr_assert_stdout_eq_str("this is a test:lol");
}

Test(prntf, testprntfchar, .init = redirect_all)
{
    prntf("this is a test:%c", 'l');
    cr_assert_stdout_eq_str("this is a test:l");
}
